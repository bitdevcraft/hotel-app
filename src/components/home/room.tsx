  ...
  return (
    <div className="min-h-[50vh] max-w-5xl mx-auto mt-32 px-4">
      ...
      <p className="text-sm text-left md:text-center mb-16">
        Whether you’re here for business or leisure, each room and suite at
        Hotel offers a sanctuary of elegance. Designed with the utmost care and
        attention to detail, our accommodations provide a luxurious escape that
